    ...
    showOnePost = (
      <div className="card mb-3 p-3">
        ...
        <div className="d-flex gap-2">
          <NavLink
            to={`/posts/${id}/edit`}
            className="ms-auto btn btn-success col-1 fs-5"
          >
            Edit
          </NavLink>
          <button onClick={deleteOnePost} className="btn btn-danger col-1 fs-5">
            Delete
          </button>
        </div>
      </div>
    ...
    <>
      <div className="card mb-3 p-3">
        ...
        <div className="card-body">
          ...
          <NavLink to={`/posts/${post.id}.json`} className="btn btn-primary">
            Read more
          </NavLink>
        </div>
      </div>
